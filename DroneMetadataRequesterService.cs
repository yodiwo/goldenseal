...
{
    public class DroneMetadataRequesterService : IHostedService, IDisposable
    {
        private readonly ILogger<DroneMetadataRequesterService> _logger;
        ...
        public DroneMetadataRequesterService(ILogger<DroneMetadataRequesterService> logger, IServiceProvider services)
        {
            _logger = logger;
            _services = services;
        }
        ...
        {
            _logger.LogInformation($"{nameof(DroneMetadataRequesterService)} is running.");
